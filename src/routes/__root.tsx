  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Ilha Inteligente — Monitoramento urbano da Ilha do Recife" },
      {
        ...
        content:
          "Alagamento, calor urbano, arborização e patrimônio histórico em um só painel de decisão.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Roboto+Mono:wght@400;500&family=DM+Sans:wght@400;500;700&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
